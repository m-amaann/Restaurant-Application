...
const createTime = (e, t = "") => {
 ...
 return () => {};
}, SLOT_FB_CSS = "slot-fb{display:contents}slot-fb[hidden]{display:none}", XLINK_NS = "http://www.w3.org/1999/xlink", FORM_ASSOCIATED_CUSTOM_ELEMENT_CALLBACKS = [ "formAssociatedCallback", "formResetCallback", "formDisabledCallback", "formStateRestoreCallback" ], EMPTY_OBJ = {}, isComplexType = e => "object" == (e = typeof e) || "function" === e, isPromise = e => !!e && ("object" == typeof e || "function" == typeof e) && "function" == typeof e.then, h = (e, t, ...o) => {
 ...
 if (e = 11 === e.nodeType ? e : doc, l) if ("string" == typeof l) {
  ...
  if (a || rootAppliedStyles.set(e, a = new Set), !a.has(s)) {
   if (BUILD.hydrateClientSide && e.host && (o = e.querySelector(`[sty-id="${s}"]`))) o.innerHTML = l; else {
    ...
    null != t && o.setAttribute("nonce", t), (BUILD.hydrateServerSide || BUILD.hotModuleReplacement) && o.setAttribute("sty-id", s), 
...
const createElm = (e, t, o, n) => {
 ...
 return l["s-hn"] = hostTagName, BUILD.slotRelocation && 3 & s.$flags$ && (l["s-sr"] = !0, 
 l["s-cr"] = contentRef, l["s-sn"] = s.$name$ || "", r = e && e.$children$ && e.$children$[o], 
 r && r.$tag$ === s.$tag$ && e.$elm$ && (BUILD.experimentalSlotFixes ? relocateToHostRoot(e.$elm$) : putBackInOriginalLocation(e.$elm$, !1))), 
 l;
}, relocateToHostRoot = e => {
 plt.$flags$ |= 1;
 const t = e.closest(hostTagName.toLowerCase());
 if (null != t) for (const o of Array.from(e.childNodes)) null != o["s-sh"] && (t.insertBefore(o, null), 
 o["s-sh"] = void 0, checkSlotRelocate = !0);
 plt.$flags$ &= -2;
...
}, isSameVnode = (e, t, o = !1) => e.$tag$ === t.$tag$ && (BUILD.slotRelocation && "slot" === e.$tag$ ? e.$name$ === t.$name$ : !(BUILD.vdomKey && !o) || e.$key$ === t.$key$), referenceNode = e => e && e["s-ol"] || e, parentReferenceNode = e => (e["s-ol"] ? e["s-ol"] : e).parentNode, patch = (e, t, o = !1) => {
 const n = t.$elm$ = e.$elm$, s = e.$children$, l = t.$children$, a = t.$tag$, r = t.$text$;
 let i;
 BUILD.vdomText && null !== r ? BUILD.vdomText && BUILD.slotRelocation && (i = n["s-cr"]) ? i.parentNode.textContent = r : BUILD.vdomText && e.$text$ !== r && (n.data = r) : (BUILD.svg && (isSvgMode = "svg" === a || "foreignObject" !== a && isSvgMode), 
 (BUILD.vdomAttribute || BUILD.reflect) && (BUILD.slot && "slot" === a || updateElement(e, t, isSvgMode)), 
 BUILD.updatable && null !== s && null !== l ? ((e, t, o, n, s = !1) => {
  ...
  u = n[--h]; else if (isSameVnode(m, u, s)) !BUILD.slotRelocation || "slot" !== m.$tag$ && "slot" !== u.$tag$ || putBackInOriginalLocation(m.$elm$.parentNode, !1), 
  patch(m, u, s), e.insertBefore(m.$elm$, p.$elm$.nextSibling), m = t[++r], u = n[--h]; else if (isSameVnode(p, f, s)) !BUILD.slotRelocation || "slot" !== m.$tag$ && "slot" !== u.$tag$ || putBackInOriginalLocation(p.$elm$.parentNode, !1), 
  patch(p, f, s), e.insertBefore(p.$elm$, m.$elm$), p = t[--$], f = n[++i]; else {
   if (d = -1, BUILD.vdomKey) for (c = r; c <= $; ++c) if (t[c] && null !== t[c].$key$ && t[c].$key$ === f.$key$) {
    d = c;
    break;
   }
   BUILD.vdomKey && d >= 0 ? (a = t[d], a.$tag$ !== f.$tag$ ? l = createElm(t && t[i], o, d, e) : (patch(a, f, s), 
   t[d] = void 0, l = a.$elm$), f = n[++i]) : (l = createElm(t && t[i], o, i, e), f = n[++i]), 
   l && (BUILD.slotRelocation ? parentReferenceNode(m.$elm$).insertBefore(l, referenceNode(m.$elm$)) : m.$elm$.parentNode.insertBefore(l, m.$elm$));
  }
  r > $ ? addVnodes(e, null == n[h + 1] ? null : n[h + 1].$elm$, o, n, i, h) : BUILD.updatable && i > h && removeVnodes(t, r, $);
 })(n, s, t, l, o) : null !== l ? (BUILD.updatable && BUILD.vdomText && null !== e.$text$ && (n.textContent = ""), 
 addVnodes(n, null, t, l, 0, l.length - 1)) : BUILD.updatable && null !== s && removeVnodes(s, 0, s.length - 1), 
 ...
 for (const s of e.childNodes) {
  if (s["s-sr"] && (t = s["s-cr"]) && t.parentNode) {
   ...
   const e = s["s-sn"];
   for (n = o.length - 1; n >= 0; n--) if (t = o[n], !(t["s-cn"] || t["s-nr"] || t["s-hn"] === s["s-hn"] || BUILD.experimentalSlotFixes && t["s-sh"] && t["s-sh"] === s["s-hn"])) if (isNodeLocatedInSlot(t, e)) {
 ...
 if (hostTagName = i.tagName, BUILD.isDev && Array.isArray(t) && t.some(isHost)) throw new Error(`The <Host> must be the single root component.\nLooks like the render() function of "${hostTagName.toLowerCase()}" is returning an array that contains the <Host>.\n\nThe render() function should look like this instead:\n\nrender() {\n  // Do not return an array\n  return (\n    <Host>{content}</Host>\n  );\n}\n  `);
 if (BUILD.reflect && d.$attrsToReflect$ && ($.$attrs$ = $.$attrs$ || {}, d.$attrsToReflect$.map((([e, t]) => $.$attrs$[t] = i[e]))), 
 o && $.$attrs$) for (const e of Object.keys($.$attrs$)) i.hasAttribute(e) && ![ "key", "ref", "style", "class" ].includes(e) && ($.$attrs$[e] = i[e]);
 if ($.$tag$ = null, $.$flags$ |= 4, e.$vnode$ = $, $.$elm$ = c.$elm$ = BUILD.shadowDom && i.shadowRoot || i, 
 (BUILD.scoped || BUILD.shadowDom) && (scopeId = i["s-sc"]), BUILD.slotRelocation && (contentRef = i["s-cr"], 
 ...
 BUILD.slotRelocation) {
  if (plt.$flags$ |= 1, checkSlotRelocate) {
   ...
   for (const e of relocateNodes) {
    ...
    if (!t["s-ol"]) {
     const e = BUILD.isDebug || BUILD.hydrateServerSide ? originalLocationDebugNode(t) : doc.createTextNode("");
   ...
   for (const e of relocateNodes) {
    ...
    if (r) {
     ...
     (!o && e !== t.parentNode || t.nextSibling !== o) && t !== o && (BUILD.experimentalSlotFixes || t["s-hn"] || !t["s-ol"] || (t["s-hn"] = t["s-ol"].parentNode.nodeName), 
 ...
 if (BUILD.experimentalScopedSlotChanges && 2 & d.$flags$) for (const e of $.$elm$.childNodes) e["s-hn"] === hostTagName || e["s-sh"] || (o && null == e["s-ih"] && (e["s-ih"] = null !== (r = e.hidden) && void 0 !== r && r), 
 e.hidden = !0);
 contentRef = void 0;
...
const callRender = (e, t, o, n) => {
 ...
 var n;
 const s = e.prototype;
 if (BUILD.formAssociated && 64 & t.$flags$ && 1 & o && FORM_ASSOCIATED_CUSTOM_ELEMENT_CALLBACKS.forEach((e => Object.defineProperty(s, e, {
  value(...t) {
   const o = getHostRef(this), n = BUILD.lazyLoad ? o.$hostElement$ : this, s = BUILD.lazyLoad ? o.$lazyInstance$ : n;
   if (s) {
    const o = s[e];
    "function" == typeof o && o.call(s, ...t);
   } else o.$onReadyPromise$.then((o => {
    const n = o[e];
  ...
  if (l.map((([e, [n]]) => {
   (BUILD.prop || BUILD.state) && (31 & n || (!BUILD.lazyLoad || 2 & o) && 32 & n) ? Object.defineProperty(s, e, {
    ...
    set(s) {
     if (BUILD.isDev) {
      ...
      0 == (1 & o) && 0 === (s && 8 & s.$flags$) && 0 != (31 & n) && 0 == (1024 & n) && consoleDevWarn(`@Prop() "${e}" on <${t.$tagName$}> is immutable but was modified from within the component.\nMore information: https://stenciljs.com/docs/properties#prop-mutability`);
     }
     setValue(this, e, s, t);
    },
    configurable: !0,
   ...
   s.attributeChangedCallback = function(e, n, l) {
    plt.jmp((() => {
     ...
     if (this.hasOwnProperty(r)) l = this[r], delete this[r]; else {
      ...
      if (null == r) {
       ...
       if (s && !(8 & s) && 128 & s && l !== n) {
        const s = BUILD.lazyLoad ? o.$hostElement$ : this, r = BUILD.lazyLoad ? o.$lazyInstance$ : s, i = null === (a = t.$watchers$) || void 0 === a ? void 0 : a[e];
        null == i || i.forEach((t => {
    ...
    var s;
    const l = n[1] || e;
    return o.set(l, e), BUILD.reflect && 512 & n[0] && (null === (s = t.$attrsToReflect$) || void 0 === s || s.push([ e, l ])), 
    l;
   })) ]));
  }
 }
 ...
 e.__appendChild = e.appendChild, e.appendChild = function(e) {
  ...
  if (o) {
   const n = getHostSlotChildNodes(o, t), s = n[n.length - 1], l = s.parentNode.insertBefore(e, s.nextSibling);
 ...
 Object.defineProperty(e, "__textContent", t), BUILD.experimentalScopedSlotChanges ? Object.defineProperty(e, "textContent", {
  get() {
   return " " + getAllChildSlotNodes(this.childNodes).map((e => {
    var t, o;
    const n = [];
    let s = e.nextSibling;
    for (;s && s["s-sn"] === e["s-sn"]; ) 3 !== s.nodeType && 1 !== s.nodeType || n.push(null !== (o = null === (t = s.textContent) || void 0 === t ? void 0 : t.trim()) && void 0 !== o ? o : ""), 
    s = s.nextSibling;
  ...
  set(e) {
   getAllChildSlotNodes(this.childNodes).forEach((t => {
    ...
    if ("" === t["s-sn"]) {
     ...
     o["s-sn"] = "", t.parentElement.insertBefore(o, t.nextSibling);
    } else t.remove();
   }));
  }
 ...
 const t = [];
 for (const o of Array.from(e)) o["s-sr"] && t.push(o), t.push(...getAllChildSlotNodes(o.childNodes));
 return t;
 ...
 BUILD.shadowDom && !supportsShadow && 1 & o.$flags$ && (o.$flags$ |= 8), BUILD.experimentalSlotFixes ? BUILD.scoped && 2 & o.$flags$ && patchPseudoShadowDom(e.prototype, o) : (BUILD.slotChildNodesFix && patchChildSlotNodes(e.prototype, o), 
 BUILD.cloneNodeFix && patchCloneNode(e.prototype), BUILD.appendChildSlotFix && patchSlotAppendChild(e.prototype), 
 BUILD.scopedSlotTextContentFix && 2 & o.$flags$ && patchTextContent(e.prototype));
 ...
 if (e.map((e => {
  e[1].map((o => {
   ...
   4 & r.$flags$ && (f = !0), BUILD.member && (r.$members$ = o[2]), BUILD.hostListener && (r.$listeners$ = o[3]), 
   ...
   BUILD.experimentalSlotFixes ? BUILD.scoped && 2 & r.$flags$ && patchPseudoShadowDom(d.prototype, r) : (BUILD.slotChildNodesFix && patchChildSlotNodes(d.prototype, r), 
   BUILD.cloneNodeFix && patchCloneNode(d.prototype), BUILD.appendChildSlotFix && patchSlotAppendChild(d.prototype), 
   BUILD.scopedSlotTextContentFix && 2 & r.$flags$ && patchTextContent(d.prototype)), 
   BUILD.formAssociated && 64 & r.$flags$ && (d.formAssociated = !0), BUILD.hotModuleReplacement && (d.prototype["s-hmr"] = function(e) {
    ((e, t, o) => {
 ...
 })), f && (d.innerHTML += SLOT_FB_CSS), BUILD.invisiblePrehydration && (BUILD.hydratedClass || BUILD.hydratedAttribute) && (d.innerHTML += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 d.innerHTML.length) {
