...
const Input = class {
    ...
    renderInput() {
        ...
        return (index.h(index.Host, { class: theme.createColorClasses(this.color, {
                 ...
                 */
                ev.preventDefault();
            }, onClick: this.clearTextInput }, index.h("ion-icon", { "aria-hidden": "true", icon: mode === 'ios' ? index$1.closeCircle : index$1.closeSharp }))), index.h("slot", { name: "end" })), shouldRenderHighlight && index.h("div", { class: "input-highlight" })), this.renderBottomContent()));
    }
    // TODO FW-2764 Remove this
    renderLegacyInput() {
