...
const index$3 = require('./index-84351d21.js');
...
const App = class {
    ...
    componentDidLoad() {
        {
            rIC(async () => {
                ...
                if (!ionicGlobal.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-10da82ce.js'); }).then((module) => module.startTapClick(ionicGlobal.config));
                }
                if (ionicGlobal.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-b0bfea34.js'); }).then((module) => module.startStatusTap());
                }
                if (ionicGlobal.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-6f804705.js'); }).then((module) => module.startInputShims(ionicGlobal.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./hardware-back-button-d23873bb.js'); });
                const supportsHardwareBackButtonEvents = isHybrid || hardwareBackButton.shoudUseCloseWatcher();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '3535eb5c0dab78a78011e552524a98599b2b650f', class: {
                [mode]: true,
                'ion-page': true,
