...
const BackButton = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '175fff2d7a41d2deaaf7b781c5ba2aac9311ebf4', onClick: this.onClick, class: theme.createColorClasses(color, {
                [mode]: true,
