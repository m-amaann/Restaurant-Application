...
Developers can use the "legacy" property to continue using the legacy form markup. This property will be removed in an upcoming major release of Ionic where this form control will use the modern form markup.`, this.el);
    ...
    renderTextarea() {
        ...
        return (index.h(index.Host, { class: theme.createColorClasses(this.color, {
            ...
            }) }, index.h("label", { class: "textarea-wrapper", htmlFor: inputId }, this.renderLabelContainer(), index.h("div", { class: "textarea-wrapper-inner" }, index.h("div", { class: "start-slot-wrapper" }, index.h("slot", { name: "start" })), index.h("div", { class: "native-wrapper", ref: (el) => (this.textareaWrapper = el) }, index.h("textarea", Object.assign({ class: "native-textarea", ref: (el) => (this.nativeInput = el), id: inputId, disabled: disabled, autoCapitalize: this.autocapitalize, autoFocus: this.autofocus, enterKeyHint: this.enterkeyhint, inputMode: this.inputmode, minLength: this.minlength, maxLength: this.maxlength, name: this.name, placeholder: this.placeholder || '', readOnly: this.readonly, required: this.required, spellcheck: this.spellcheck, cols: this.cols, rows: this.rows, wrap: this.wrap, onInput: this.onInput, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, onKeyDown: this.onKeyDown }, this.inheritedAttributes), value)), index.h("div", { class: "end-slot-wrapper" }, index.h("slot", { name: "end" }))), shouldRenderHighlight && index.h("div", { class: "textarea-highlight" })), this.renderBottomContent()));
    }
    render() {
