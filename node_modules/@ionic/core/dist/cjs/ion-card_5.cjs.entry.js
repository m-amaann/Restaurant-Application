...
const Card = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9e35c114ce466623024b94dd6797118ad027417d', class: theme.createColorClasses(this.color, {
                [mode]: true,
...
const CardContent = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'd4da147bb0b0b14684b54d37d04ba5a8f7a7d71d', class: {
                [mode]: true,
...
const CardHeader = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '070294064c4b17c941961c9cccf1ae6592b385b6', class: theme.createColorClasses(this.color, {
                'card-header-translucent': this.translucent,
                'ion-inherit-color': true,
                [mode]: true,
            }) }, index.h("slot", { key: 'adac918d5e93bf69b07c5bda329ebf8c719bd623' })));
    }
};
CardHeader.style = {
...
const CardSubtitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: 'ae115cf349cd13f88d20b1fbab6b8a813a87b925', role: "heading", "aria-level": "3", class: theme.createColorClasses(this.color, {
                'ion-inherit-color': true,
                [mode]: true,
            }) }, index.h("slot", { key: 'f5dd779b34b5c5c541cbbe56cc8a877e50513252' })));
    }
};
CardSubtitle.style = {
...
const CardTitle = class {
    ...
    render() {
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '432d7bf971fda63c30c748986143ec2a8be9e4af', role: "heading", "aria-level": "2", class: theme.createColorClasses(this.color, {
                'ion-inherit-color': true,
                [mode]: true,
            }) }, index.h("slot", { key: '3c5dcf6ac1bf981c6c0488f0027765269c80db5a' })));
    }
};
CardTitle.style = {
