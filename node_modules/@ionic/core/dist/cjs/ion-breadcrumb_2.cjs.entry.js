...
const Breadcrumb = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '632efa1bc6dc446e81efe8cd7763cb9b16466563', onClick: (ev) => theme.openURL(href, ev, routerDirection, routerAnimation), "aria-disabled": disabled ? 'true' : null, class: theme.createColorClasses(color, {
                [mode]: true,
...
const Breadcrumbs = class {
    ...
    render() {
        ...
        const mode = ionicGlobal.getIonMode(this);
        return (index.h(index.Host, { key: '35f8a2bffdd85ba6dc31834ebef69602a5a7cca1', class: theme.createColorClasses(color, {
                [mode]: true,
                'in-toolbar': theme.hostContext('ion-toolbar', this.el),
                'in-toolbar-color': theme.hostContext('ion-toolbar[color]', this.el),
                'breadcrumbs-collapsed': collapsed,
            }) }, index.h("slot", { key: 'ada062b5d17380d311861d1cf1a22dd62bac5497', onSlotchange: this.slotChanged })));
    }
    get el() { return index.getElement(this); }
