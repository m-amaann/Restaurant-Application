...
const index$1 = require('./index-8c679cbf.js');
...
const Menu = class {
    ...
    render() {
         ...
         */
        return (index.h(index.Host, { key: 'be7145625a30951e5cc26646f6121ee4fa4c910f', onKeyDown: hardwareBackButton.shoudUseCloseWatcher() ? null : this.onKeydown, role: "navigation", "aria-label": inheritedAttributes['aria-label'] || 'menu', class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
                'menu-enabled': !disabled,
                [`menu-side-${side}`]: true,
                'menu-pane-visible': isPaneVisible,
            } }, index.h("div", { key: 'ecd6e0641ed67691db270190801f7be365a2d121', class: "menu-inner", part: "container", ref: (el) => (this.menuInnerEl = el) }, index.h("slot", { key: 'aea3780e259f2b3ea84697a509bb7f13fa9531e9' })), index.h("ion-backdrop", { key: 'be3253506a34c4c00eb1814621c674196b72db46', ref: (el) => (this.backdropEl = el), class: "menu-backdrop", tappable: false, stopPropagation: false, part: "backdrop" })));
    }
